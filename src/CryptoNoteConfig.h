...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1080; //NS
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(20218446744073709551616);
...
const char     CRYPTONOTE_NAME[]                             = "NSYS";
